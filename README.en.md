...
| `npm run docs:check`            | Validate bilingual document pairs, technical literals, and local links.  |
...
| `npm run verify`                | Run format, bilingual docs, lint, typecheck, tests, and build.           |
