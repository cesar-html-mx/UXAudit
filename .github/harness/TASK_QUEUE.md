...
- [x] M07-T02 Extract normalized component import, export, and use facts.
- [x] M07-T03 Resolve direct relative component links deterministically.
- [x] M07-T04 Evaluate multiple H1 headings across bounded component composition.
- [x] M07-T05 Execute the six-hour viability gate and retain evidence.

## M08 — Bounded contextual component analysis and realistic validation

- [ ] M08-T01 Define transparent-wrapper and source-versus-usage semantics.
- [ ] M08-T02 Project supported static props and children through wrappers.
- [ ] M08-T03 Adapt prioritized rules to bounded contextual projections.
- [ ] M08-T04 Validate a realistic multi-file React consumer.
- [ ] M08-T05 Complete release-quality regression, documentation, and evidence gates.
