...
const contractPath = fileURLToPath(
  new URL('../../../fixtures/m06-validation/heuristic-review.json', import.meta.url),
);
...
describe('M06 expert heuristic review contract', () => {
  it('is canonical JSON with one closed six-task sequence', async () => {
    ...
    expect(contract.reviewId).toBe('M06-EXPERT-HEURISTIC-REVIEW');
