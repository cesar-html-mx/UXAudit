...
| RF-11       | `RuleFinding`, `Finding`, and rule implementations      | M04         | evaluator zero/one/multiple/transactional-invalid-result cases plus catalog tests                                               |
...
| RF-14       | Rule/finding classification and AuditResult             | M04/M05     | exact category/severity/confidence contract plus later grouping and ordering                                                    |
