...
| RF-14       | Rule/finding classification and AuditResult             | M04/M05   | deterministic four-category finding order/counters in M04; later AuditResult grouping/policy                                    |
...
| RNF-04      | scan/analyze pipeline, model builder, and rule engine   | M02-M06   | reviewed full-catalog expected JSON, two byte-identical evaluations, stable filters/errors, and prior pipeline reruns           |
...
| RNF-06      | `RuleMetadata`, normalized findings, and reporters      | M04-M06   | complete explanation/recommendation/reference/limitations assertions, then reporter usability tasks and heuristic review        |
