...
const fixtureDirectory = path.join(repositoryRoot, 'tests', 'fixtures', 'parsing');
...
const outputDirectory =
  outputIndex >= 0 && argumentsList[outputIndex + 1]
    ...
    : undefined;
const temporaryRoot = await mkdtemp(path.join(tmpdir(), 'uxaudit-parsing-scenario-'));
...
try {
  ...
  console.log('UXAudit controlled parsing and model scenario: PASS');
  console.log(
